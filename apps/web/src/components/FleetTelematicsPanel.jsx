...
export default function FleetTelematicsPanel({
  ...
  const setSelectedVehicle = (v) => setSelectedVehicleId(v.id);
  const [loading, setLoading] = useState(false);

  return (
    <div
      className="fleet-layout"
      style={{
        display: "flex",
        gap: "20px",
        height: "100%",
          ...
          {vehicles.map((v) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span>
                    Corridor: <b>{v.corridor_id}</b>
                  </span>
                  <span>
                    Velocity:{" "}
                    <b
                      style={{
                        color: v.current_speed < 25 ? "#EF4444" : "#10B981",
                      }}
                    >
          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ fontSize: "0.82rem", color: "var(--text-sub)" }}>
                  {selectedVehicle.operator} · Corridor{" "}
                  {selectedVehicle.corridor_id}
                </div>
              </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontWeight: 600,
                    color:
                      selectedVehicle.current_speed < 25
                        ? "#EF4444"
                        : "#10B981",
                  }}
                >
            ...
            >
              ...
              >
                ...
                <button
                  onClick={() =>
                    onTriggerSpeedAnomaly(selectedVehicle.corridor_id)
                  }
              ...
              >
                <b>Chain 2:</b> Simulates vehicle entering active danger zone,
                firing `VEHICLE_ENTERED_RISK_ZONE` telematics alert.
                <br />
                <b>Chain 5:</b> Simulates multi-vehicle clustering/slowdown on
                corridor, raising corridor risk score before any human report is
                filed.
              </div>
            </div>
          </div>
