  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {/* Filter Pills */}
        <input
          aria-label="Find a corridor"
          placeholder="Search road, town or state"
          value={search}
              ...
              style={{
                ...
                background:
                  filter === f
                    ...
                    : "var(--bg-surface-2)",
                color:
                  filter === f ? "var(--primary-accent)" : "var(--text-muted)",
                fontSize: "0.72rem",
                fontWeight: 600,
                cursor: "pointer",
            ...
            <div
              ...
              style={{
                ...
                boxShadow: isSelected
                  ? "0 4px 18px rgba(232, 121, 249, 0.15)"
                  : "none",
              }}
            >
              <div
              ...
              >
                ...
                <span>
                  Speed: {road.current_speed} / {road.baseline_speed} km/h
                </span>
          ...
          >
            ...
            >
              ...
              <div style={{ fontWeight: 600, color: "#FFFFFF" }}>
                {selectedCorridor.slope_deg}° inclination
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontWeight: 600, color: "#FFFFFF" }}>
                {selectedCorridor.historical_incidents} logged
              </div>
            </div>
          </div>
