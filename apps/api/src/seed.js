...
const STATES = [
  ...
  { id: "MN", name: "Manipur", capital: "Imphal", lat: 24.817, lng: 93.9368 },
  ...
  {
    id: "WB",
    name: "West Bengal (Siliguri Gate)",
    capital: "Siliguri",
    lat: 26.7271,
    lng: 88.3953,
  },
...
const GLACIAL_LAKES = [
  {
    ...
    description:
      "High altitude proglacial lake in Chungthang catchment. Site of October 2023 catastrophic GLOF and NDMA high-risk priority.",
    polygon_coordinates: [
      [88.195, 27.91],
      [88.215, 27.91],
      [88.22, 27.925],
  ...
  },
  {
    ...
    description:
      "NDMA flagged proglacial expansion lake in eastern Himalayan zone.",
    polygon_coordinates: [
      [95.81, 28.94],
      [95.83, 28.94],
      [95.835, 28.955],
...
const VEHICLES = [
  {
    ...
    heading: 85.0,
    cargo_summary:
      "Life-saving emergency pediatric antibiotics and insulin supply",
  },
  {
    id: "NL-RAT-04",
...
const INITIAL_INCIDENTS = [
  {
    ...
    lng: 93.82,
    description:
      "Sludge displacement and debris across 80m of roadway near Pagla Pahar curve. Heavy vehicle passage restricted.",
    severity: "HIGH",
  ...
  },
  {
    ...
    lng: 88.52,
    description:
      "River Teesta undercut lower foundation embankment. Single lane convoy regulation in place.",
    severity: "HIGH",
    source: "FIELD_OFFICER_OFFLINE_SYNC",
    sync_status: "SYNCED",
  },
...
const INITIAL_ALERTS = [
  {
    ...
    message:
      "Rainfall exceeds 70mm/24hr threshold on NH-10. Disruption probability evaluated at 74%. Alternate routing via Lava/Algarah advised.",
    translations: {
  ...
  },
  {
    ...
    message:
      "Fuel transport vehicle NL-POL-09 detected inside active hazard polygon on NH-10. Automated safety telematics triggered.",
    translations: {
...
export async function runSeed() {
  if (process.env.APP_MODE === "production")
    throw new Error("Demo reset is forbidden in production mode.");
  if (process.env.ALLOW_DEMO_RESET !== "true")
    throw new Error(
      "This resets all demo records. Use only an isolated demo database and set ALLOW_DEMO_RESET=true.",
    );
  ...
  try {
    ...
    for (const c of CORRIDORS) {
      ...
      await client.query(
        ...
        [
          ...
          c.rainfall_trend,
          c.slope_deg,
          c.historical_incidents,
          lineStringWKT,
          JSON.stringify(c.coords),
        ],
      );
    }
    ...
    for (const l of GLACIAL_LAKES) {
      ...
      await client.query(
        ...
        [
          ...
          l.moraine_stability,
          l.monitoring_status,
          l.downstream_corridor_id,
          polyWKT,
          JSON.stringify(l.polygon_coordinates),
          l.description,
        ],
      );
    ...
    for (const r of RISK_ZONES) {
      ...
      await client.query(
        ...
        [
          ...
          r.severity,
          polyWKT,
          JSON.stringify(r.polygon_coordinates),
          r.source,
        ],
      );
    }
    ...
    console.log(
      "Database seeded successfully with 16 NER corridors, lakes, vehicles, zones!",
    );
  } catch (err) {
